<template>
  <div>
    <el-row style="border-bottom: 1px solid #eaeaea;">
      <el-col :span="20"><h4>字典列表</h4></el-col>
      <el-col :span="4" style="line-height: 60px;text-align: center;">
        <el-row>
          <el-col :span="12"><insertComponent @refresh="getList" /></el-col>
          <el-col :span="12"><updateComponent v-if="checkedItem" :itemid="checkedItem.id" @refresh="getList" /></el-col>
        </el-row>
      </el-col>
    </el-row>
    <el-table ref="table" v-loading="listLoading" :data="list" element-loading-text="Loading" stripe fit highlight-current-row @row-click="checkedTableRow">
...
export default {
  ...
  methods: {
    getList() {
      ...
      getList('dictionary', data, '/selectDictList').then(response => {
